                    ...
                    <div class="mt-4 sm:mt-0 sm:ml-10">
                        <nav class="-mb-px flex space-x-8">
                            <a v-for="(tab, i) in tabs" :key="i" v-bind="activeItem" @click="selectItem(i,tab.category)"
                               :class="[i === activeItem ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300', 'whitespace-nowrap pb-4 px-1 border-b-2 font-medium text-sm']"
