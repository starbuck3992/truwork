  ...
  <div class="relative bg-mycolor pt-10 pb-32 overflow-hidden">
      ...
      <div class="bg-mycolor">
        <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div class="text-center">
            ...
            <p class="max-w-xl mt-5 mx-auto text-xl text-gray-500">Vyrábíme kvalitní kuchyňský nábytek z masivu v tradičním i moderním vzhledu. Každý kus je ručne vyrobeným a lakovaným originálem, který se stane ozdobou každého interiéru. Řemeslná zručnost, preciznost a osobní přístup je zárukou nejvyšší kvality a spokojenosti zákazníka.</p>
          </div>
        </div>
      </div>
    </section>
    <section id="content">
      ...
      <div id="mycommercial" class="opacity-0 transition-all duration-4000 relative mt-24">
        <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
          ...
          <div class="mt-12 sm:mt-16 lg:mt-0">
            <div class="pl-4 -mr-48 sm:pl-6 md:-mr-16 lg:px-0 lg:m-0 lg:relative lg:h-full">
              <img class="w-full rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:left-0 lg:h-full lg:w-auto lg:max-w-none" src="https://cdn.pixabay.com/photo/2017/07/09/03/19/home-2486092_960_720.jpg" alt="Inbox user interface" />
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="contact-as">
      <div id="myform" class="opacity-0 transition-all duration-4000 max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8 mt-5">
        <div class="text-center">
          <p class="mt-1 mb-12 text-4xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight lg:text-6xl">Kontaktujte nás!</p>
        </div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
              <form @submit.prevent="submit" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                ...
                <div class="sm:col-span-2">
                  <div class="flex justify-between">
                    <label for="message" class="block text-sm font-medium text-gray-900">Text</label>
                    <span id="message-max" class="text-sm text-gray-500">Max. 500 characters</span>
                  </div>
                  <div class="mt-1">
                    <textarea v-model="form.message" id="message" name="message" rows="4" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:ring-indigo-500 focus:border-indigo-500 border border-gray-300 rounded-md" aria-describedby="message-max" />
                  </div>
                </div>
