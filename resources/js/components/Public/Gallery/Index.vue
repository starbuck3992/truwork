...
<main>
  <div v-for="(gallery, i) in galleries" :key="i" class="bg-white">
    <router-link :to="{ name: 'galleriesShow', params: {slug: gallery.slug } }" class="max-w-2xl mx-auto py-4 px-4 sm:px-6 lg:max-w-7xl">
      <div class="relative rounded-lg overflow-hidden lg:h-128">
        <div class="absolute inset-0">
          <img :src="gallery.thumbnail[0].path" :alt="category" class="w-full h-full object-center object-cover" />
        </div>
